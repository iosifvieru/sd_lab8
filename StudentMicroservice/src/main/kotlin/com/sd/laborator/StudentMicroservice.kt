        ...
        while (true) {
            ...
            thread {
                ...
                when(messageType) {
                    ...
                    "dummy" -> {
                        println("Mesaj de la microserviciul Heartbeat[$messageDestination]: \"${messageBody}\"")

                        val message = "raspuns $messageDestination ${messageManagerSocket.localPort} is online."
                        println("Trimit raspunsul: $message")
